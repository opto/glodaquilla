...
addEventListener("click", async (event) => {
	if (event.target.id.startsWith("donate1")) {
		...
		messenger.Utilities.openLinkExternally("https://www.paypal.com/donate?hosted_button_id=E5FNJXGXA9KWL");
	  };
	  if (event.target.id.startsWith("donate")) {
	
		messenger.windows.openDefaultBrowser("https://www.paypal.com/donate?hosted_button_id=E5FNJXGXA9KWL");
	  };
	});
